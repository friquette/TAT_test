...
def build_speed_rig():
    ...
    # apply freeze transform and center pivot
    ...
    # create the groups and the parenting
    ...
    # set the size of the box to the size of the mesh
